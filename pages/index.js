...
export default function Home() {
  return (
    <div className="container">
      ...
      <main>
        <img src="/profile.png" alt="Profile Picture" height="200" />
        <h1 className="title">
          Pranav Purwar
        </h1>

        <p className="description">
          14yo hobbyist dev. Does javascript, typescript, next.js, React, python, java, html, etc.
        </p>

        <div className="grid">
          <a href="https://github.com/PranavPurwar" className="card">
            <h3>Github &rarr;</h3>
            <p>Find the source code of my projects.</p>
          </a>
      ...
      <footer>
        <a
          href="https://github.com/PranavPurwar/pranavpurwar.ga"
        >
